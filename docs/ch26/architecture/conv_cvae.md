...
`ConvConditionalVAE`의 앞먹임을 따라가며 텐서 꼴을 좇아라. 붙박이 매개변수로 들임 표본 4개짜리 배치에 대해 주요 연산(누비기, 모으기, 선형 층)마다 그 뒤의 꼴을 적어라.
...
??? success "연습문제 9 풀이"
    ...
    **같게 맞출 것**: 숨은 차원 16, 20 에포크, 배치 256, 학습률 1e-3, 씨앗 42를 모델
