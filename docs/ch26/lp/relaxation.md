...
이 마당은 정수 선형 계획에서 선형 계획 느슨하게 하기로、정수 틈、꼭짓점 덮기의 선형 계획 느슨하게 하기、모임 덮기의 선형 계획 느슨하게 하기을 차례로 짚었다.
