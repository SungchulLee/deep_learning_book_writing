...
def demo_action_spaces():
    ...
    # 밑천 움직임 머리
    features = torch.randn(4, 64)  # 배치 크기 4
    n_assets = 5
...
```
============================================================
Action Space Demonstrations
============================================================

softmax mode:
  Weights[0]: [0.446 0.124 0.19  0.123 0.117]
  Sum: 1.0000
  L1 norm: 1.0000

long_short mode:
  Weights[0]: [-0.242 -0.877  0.439  0.302  0.379]
  Sum: 0.0000
  L1 norm: 2.2389

leverage mode:
  Weights[0]: [ 0.077 -0.214 -0.53  -0.265  0.413]
  Sum: -0.5194
  L1 norm: 1.5000

----------------------------------------
Discrete actions: 25 (5 bins × 2 dims)
  Action  0 → [-1. -1.]
  Action  6 → [-0.5 -0.5]
  Action 12 → [0. 0.]
  Action 24 → [1. 1.]
