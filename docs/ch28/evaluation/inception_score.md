# 퍼짐 모형을 위한 인셉션 점수(IS)
인셉션 점수는 미리 익힌 Inception-v3 가름개로 만들어 낸 그림의 품질과 다양함을 따진다. 온전한 수학 이끌어 냄, 짜기, 한계 살핌은 [27.4절의 인셉션 점수](../../ch27/gan_evaluation/inception_score.md)를 보라. 이 쪽은 퍼짐 모형에 남다른 쓰임을 다룬다.
...
!!! note "인셉션 점수는 참 자료를 넘어설 수 있다"
    GAN은 이따금 참 자료보다 높은 인셉션 점수를 얻는데, 최빈값 무너짐이 헤아림을 더 적고 더 자신 있는 갈래에 몰아 주기 때문이다. 그래서 인셉션 점수만으로는 그르칠 수 있으니 늘 FID와 [정밀도·재현율](../../ch27/gan_evaluation/precision_recall.md)을 함께 보라.
...
인셉션 점수는 GAN에서와 똑같은 바탕 한계를 지니며([27.4절](../../ch27/gan_evaluation/inception_score.md#limitations-and-pitfalls) 참고) 퍼짐 모형에는 다음이 더해진다.
...
짜기 코드, 정보 이론으로 본 풀이, 가장 좋은 버릇은 [27.4절](../../ch27/gan_evaluation/inception_score.md)의 두루 갖춘 인셉션 점수 설명을 보라.
