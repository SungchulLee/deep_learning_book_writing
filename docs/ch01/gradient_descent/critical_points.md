...
- **Momentum**: Helps escape saddle points, see [Classical Momentum](../../ch02/optimizers/classical_momentum.md)
- **Batch Normalization**: Prevents saturation, see [Batch Normalization](../../ch02/normalization/batch_norm.md)
