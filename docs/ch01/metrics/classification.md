...
Classification metrics evaluate how well models distinguish between classes. This section covers the confusion matrix foundation, then accuracy, precision, recall, F1, ROC-AUC, and PR-AUC.
