...
!!! note "Cross-Reference"
    The RAG architecture — including dense retrieval, document chunking strategies, and retrieval-augmented generation pipelines — is covered in detail in [Section 6.8: RAG Fundamentals](../rag/fundamentals.md).
...
**Next:** [6.11.6 Challenges and Limitations](challenges.md)
