...
3. **임베딩**: 미리 익힌 말 모델(BERT, GPT)로 글 임베딩을 만든다
4. **쓰는 이 됨됨이 그리기**: 읽은 지난 일과 꾸러미로 쓰는 이 임베딩을 만든다
...
이 마당은 핵심 개념, 수학적 틀, 연구 내용을 위한 자연어 다루기 재주, 내용 바탕 연구 추천을 차례로 짚었다.
