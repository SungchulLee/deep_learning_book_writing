...
1. 켜마다의 쓸모 퍼뜨리기(LRP)
----------------------------------------------------------------------
생각: 쓸모를 거꾸로 퍼뜨려 미루어 봄을 쪼갠다
꼴: R_i = Σ_j (z_ij / Σ_k z_kj) R_j
나은 점: 지켜짐 됨됨이를 채운다
...
생각: 살아남을 견줌 살아남과 견준다
꼴: 밑금과의 차이로 몫을 매긴다
나은 점: 기울기가 잦아든 자리를 더 잘 다룬다
쓰일 자리: 기울기가 사라지거나 터질 때

4. SHAP(더해지는 섀플리 풀이)
----------------------------------------------------------------------
생각: 놀이 이론으로 몫을 매긴다
꼴: 함께 하는 놀이 이론의 섀플리 값
...
다음 걸음:
1. 제 모형에 이 방법들을 걸어 본다
2. Captum 곳집에서 더 많은 재주를 살핀다
3. 처음 논문을 읽어 더 깊이 안다
4. 여러 얼개로 해 본다
