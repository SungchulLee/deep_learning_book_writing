...
Use parameter-efficient methods (LoRA, adapters) that freeze pretrained weights—see Ch 15.6.
...
For parameter-efficient methods (LoRA, QLoRA, Prefix Tuning, Adapters), see Ch 15.6 Efficient LLM Fine-tuning.
