...
- **찾아 붙이기(RAG):** 찾아온 글월에 만들어 내기를 뿌리내리게 하면 헛것 지어내기가 줄지만 없어지지는 않는다. 22.5절 찾아 붙여 만들어 내기 개요를 보라.
...
!!! note "엇갈린 참고"
    공정함 잣대(인구 특성 균형, 고른 승산, 어림 균형, 눈금 맞추기)의 엄밀한 정의와 수학 세우기는 [42장: 치우침과 공정함](../../ch41/index.md)을 보라.
