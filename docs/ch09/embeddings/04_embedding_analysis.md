...
**연습문제 4.**
임베딩 분석 구현을 검증하는 종합 시험 함수를 작성하라. 빈 입력, 원소가 하나뿐인 입력, 아주 큰 입력, 극단적인 값(0, 아주 큰 수)을 가진 입력 같은 경계 상황을 시험하라.
...
이 구현은 깔끔하고 읽기 좋은 PyTorch 코드로 낱말 임베딩의 핵심 개념을 보인다.
