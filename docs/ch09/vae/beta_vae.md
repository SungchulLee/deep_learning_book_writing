# Section 41.6: β-VAE and Disentanglement
...
- The β hyperparameter and its effect
- Disentangled representations
- Measuring disentanglement
- Latent traversals for visualization
...
## Next: Conditional VAE

The next section covers conditioning VAEs on labels for controlled generation.
