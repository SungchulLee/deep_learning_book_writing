...
- **초기화**: [Xavier 초기화](../../ch06/feedforward/depth_vs_width.md)에서 다룬다
- **정칙화**: [L2 정칙화](../../ch06/regularization/l2_regularization.md) 참고
- **적응적 최적화기**: 비볼록 문제에 도움이 된다. [Adam](../../ch07/optimizers/adam.md) 참고
