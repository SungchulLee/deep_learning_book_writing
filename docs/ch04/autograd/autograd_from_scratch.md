...
============================================================
  c = (a * 4) + 3,  a = 3
  dc/da = 4.0   (expected 4)
  dc/db = 1.0   (expected 1)

============================================================
Part 2: Multi-path computation graphs
============================================================
  e = ((a*4)+3) * (a+2),  a = 3
  de/da = 35.0  (expected 35)
  Manual check: 8*3 + 11 = 35

============================================================
Part 3: Extended operations
============================================================
  f(x) = (x² - 1)/(x + 1) at x = 3
  f(3) = 2.0000  (expected 2.0)
  df/dx = 1.0000
  Expected: 1.0

============================================================
Part 4: Tensor-level automatic differentiation
============================================================
  X shape: (4, 3), W shape: (3, 2)
  y = X @ W + b, loss = sum(y)
  loss = -15.6822
  dL/dW shape: (3, 2)
  dL/dW:
...
**다룬 것** — Autograd 바닥부터 만들기

이 코드는 `requires_grad=True`인 텐서에 대한 연산을 자동으로 추적하는 PyTorch의 autograd 체계를 보여준다.

핵심 클래스는 `NumberWithGrad`, `TensorWithGrad`이며 앞의 연습문제 3개로 직접 확인할 수 있다.
