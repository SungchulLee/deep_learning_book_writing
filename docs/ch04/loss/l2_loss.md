...
!!! note "함께 볼 것"
    ...
    여러 회귀 손실을 나란히 견주어 보는 것은 [6장의 회귀 손실의 비교](../../ch06/loss/02_regression_losses_comparison.md)이고,
    이상치에 견디는 절충안은 [후버 손실](../../ch06/loss/huber_loss.md)이다.
    이름이 비슷하지만 하는 일이 전혀 다른 **L2 정칙화**는 [5장](../../ch05/regularization/l2_regularization.md)에서 다룬다.
...
!!! warning "L2 손실과 L2 정칙화는 다른 것이다"
    ...
    둘은 함께 쓰이며 서로를 대신하지 못한다. 자세한 것은 [5장](../../ch05/regularization/l2_regularization.md)에 있다.
