...
CBAM은 잇따른 두 작은 배치로 이루어진다. 갈래 눈길 묶음은 고르게 모으기와 가장 크게 모으기로 자리 소식을 모아 갈래끼리의 사이를 쓴다. 둘을 나누어 쓰는 여러 켜 퍼셉트론에 넣고 그 결과를 아우른다. 이렇게 두 가지로 모으면 고른 되받음(어떤 결이 두루 있는지)과 가장 도드라진 되받음(어떤 결이 가장 센지)을 함께 담아, 하나만 쓸 때보다 넉넉한 갈래 밝힘을 얻는다.
