...
??? success "연습문제 1 풀이"
    여느 엮음($1 \times 1$): $64 \times 128 = 8192$개. `GhostModule`에서는 으뜸 엮음($1 \times 1$)이 $64 \times 64 = 4096$개, 값싼 셈(깊이별 $3 \times 3$)이 $64 \times 9 = 576$개다. 그림자 모두: $4096 + 576 = 4672$개. 줄임 견줌: $8192 / 4672 \approx 1.75\times$. 배치 잣대 잡기와 치우침 없는 설정까지 넣으면 그림자 묶음은 여느 엮음의 매개변수 가운데 대략 57%만 쓴다.
