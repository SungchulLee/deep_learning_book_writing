...
HRNet을 가르는 결은 나란한 여러 결 얼개다. 결을 먼저 줄였다가 되찾는 여느 부호기-풀개나 결 두겁 방식 대신, HRNet은 높은 결의 흐름을 내내 지키며 낮은 결의 나란한 흐름을 차츰 더한다. 여러 잣대 녹이기 배치가 모든 결 켜 사이에서 소식을 거듭 주고받아, 높은 결의 흐름이 낮은 결이 지닌 뜻의 넉넉함을 얻으면서도 잔 자리 결을 지킨다.
