...
익히는 동안 가운데 켜에 붙이는 도움 분류기는 덧붙은 기울기 신호를 주어 아주 깊은 그물에서 기울기가 사라지는 탈에 맞선다. 작은 값(0.3)으로 짐을 주고 미루어 볼 때는 떼어 낸다. 기울기 사라짐을 막는 데 얼마나 이바지하는지는 말이 갈리지만, 가운데 드러냄에서 가려내는 결을 북돋우어 잘 듣는 다독임 노릇을 한다.
