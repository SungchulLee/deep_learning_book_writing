...
Learning Rate Schedulers 짜보기가 옳은지 두루 따지는 시험 함수를 써라. 빈 들임, 원소 하나짜리 들임, 아주 큰 들임, 값이 끝으로 치우친 들임(0, 아주 큰 수)까지 금 언저리를 시험하여라.
...
이 짜보기는 깔끔하고 읽기 쉬운 PyTorch 코드로 잔손질 묶음의 고갱이 깨침을 보인다.
