...
눈여겨볼 것: *그 자리 어텐션*(창을 쓰는 스스로 어텐션)을 배우기 위해 짜 본 것이다.
...
class WindowSelfAttention(nn.Module):
    """
    손쉽게 짠 창 스스로 어텐션(알아보기 쉽도록 머리 하나).

    자리 i마다 [i-w, i+w] 안의 낱말에만 어텐션을 준다.
