...
그래프 신경망으로 사회 그물 살피기는 그래프 신경망 쓰임새의 중요한 개념이다. 이 짜기는 얽힌 핵심 알고리즘과 자료 얼개를 손으로 만져 보게 하며 이론 바탕과 실제로 펼칠 때 살필 것을 함께 보여 준다.

## 1. 코드

```python
"""29.7.3: 그래프 신경망으로 하는 사회 그물 살피기."""
...
이 짜기는 그래프 신경망 사회 그물 살피기의 핵심 연산을 짜는 여러 도구 함수를 한가운데 둔다. 코드는 알고리즘 조각을 보여 주기와 따지기 논리에서 떼어 놓는 조각 짜기를 따른다.
...
**다룬 것** — 그래프 신경망으로 사회 그물 살피기

이 짜기는 그래프 신경망 사회 그물 살피기의 핵심 연산을 짜는 여러 도구 함수를 한가운데 둔다.
