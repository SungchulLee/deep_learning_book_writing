...
방법                   NLL     RMSE    덮음90%
---------------------------------------------
Laplace          219.130 6142289553577.813    1.50%
Ensemble           5.349    0.710   58.50%

======================================================================
확률 기울기 랑주뱅 움직임
======================================================================

매개변수 31개로 SGLD를 돌리는 중...
SGLD: 표본 300개를 모았다
...
매개변수 31개로 VI을 돌리는 중...
(수로 셈하는 기울기 탓에 좀 걸릴 수 있다)
VI: 가장 좋게 하기를 마쳤다, 마지막 ELBO = nan
...
| 이야기 | 장 | 이어짐 |
|-------|---------|------------|
| 앞선 분포 정하기 | 43장: 짐의 앞선 분포 | 뒷분포의 들임 |
| 아리송함 | 43장: 아리송함 | 뒷분포가 쪼갬을 이룬다 |
| MC 드롭아웃 | 43장: MC 드롭아웃 | 넌지시 하는 변이 미루어 봄 |
