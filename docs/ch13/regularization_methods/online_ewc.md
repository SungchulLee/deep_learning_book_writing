...
계량 금융에서 온라인 EWC는 쉼 없이 배우는 적응 체계에 특히 값지다. 시장 상황이 차츰 바뀌면 온라인 중요도 어림이 달라지는 매개변수의 쓸모에 맞추어 가며, 지금 결정적인 매개변수는 지키고 낡은 앎은 덮어쓰게 한다.
...
온라인 EWC는 쌓인 성능을 더 잘 지키며, 특히 차례가 길 때 그렇다.
...
!!! warning "맞추어 가는 금융 체계"
    ...
    흐르는 시장 데이터로 쉼 없이 배우려면 온라인 EWC를 쓰라.
    
    **1시간째**: 지금 시장의 본새를 배우고 중요도를 셈한다
    **2~24시간째**: 시장이 바뀌는 동안 중요도를 쉼 없이 온라인으로 고친다
    **둘째 날**: 새 자산 갈래를 들여오면 온라인 EWC가 배운 시장 앎을 지킨다
...
이 마당은 핵심 개념、수학적 틀、중요도 갱신의 얼개、중요도의 한결같음 다루기을 차례로 짚었다.
