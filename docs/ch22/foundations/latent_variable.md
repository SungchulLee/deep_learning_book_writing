...
The next section covers [Information Theory Foundations](information_theory.md), which provides the mathematical language of uncertainty, compression, and representation that underpins VAEs.
