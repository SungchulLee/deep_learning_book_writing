...
- 신경 기계 옮김 — 인코더-디코더 얼개와 앎의 병목
- 기계 옮김의 어텐션 — 옮김을 위한 더하기, 곱하기, 점곱 어텐션
- [변환기 기계 옮김](machine_translation/transformer_mt.md) — 되돌이 그물 바탕 옮김을 갈음하는 여러 머리 스스로 어텐션
...
- 차례에서 차례로 간추리기 — 어텐션을 갖춘 인코더-디코더 모델
...
이 마당은 말 나타내기, 차례 이름표 붙이기, 글 가르기, 앎 뽑기를 차례로 짚었다.
