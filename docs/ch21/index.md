...
- ResNeXt -- 개수 차원을 둔 배치 합성곱(2017)
- ShuffleNet -- 배치를 넘나드는 정보 흐름을 위한 통로 섞기(2018)
- EfficientNet -- 깊이, 너비, 해상도의 어우른 규모 키우기(2019)
- NFNet -- 배치 고르게 하기를 없앤, 고르게 하는 층 없는 망(2021)
...
- [나누기의 바탕](segmentation/segmentation_overview.md) -- 화소별 가르기, 인코더-디코더 방식, 값매김 잣대
- 뜻 나누기 -- 자료 늘리기부터 실제 운영까지의 온전한 흐름
- 낱낱 나누기 -- Mask R-CNN과 한 단계 낱낱 나누기 방식
- 두루 나누기 -- "바탕"과 "물체"를 하나로 꿴 나누기
- FCN -- 빽빽한 미리봄을 위한 온전한 합성곱 망
- [U-Net](segmentation/unet.md) -- 생의학 그림을 위한, 건너뛰기 이음을 갖춘 대칭 인코더-디코더
...
- 뜻 나누기 익힘책 -- PyTorch로 하는 뜻 나누기의 단계별 익힘 배치
- 보기 1: 기본 U-Net -- 밑바닥부터 만든 U-Net으로 하는 두 값 나누기
- 보기 2: 미리 익힌 인코더 -- ResNet과 EfficientNet 등뼈, DeepLabV3을 쓴 옮김 배움
...
- 물체 알아내기 익힘책 -- PyTorch로 하는 물체 알아내기의 단계별 익힘 배치
...
이 마당은 그림 가르기, 나누기, 알아내기, 영상을 차례로 짚었다.
