...
[24장](../ch24/index.md)의 자기 부호기는 다시 세우기는 잘하면서도 숨은 공간에서 뽑지는 못했다. 코드가 놓이는 자리를 아무도 단속하지 않기 때문이었다. 이 장은 그 자리를 단속해 사다리의 세 번째 칸에 오른다. 부호기가 코드 하나가 아니라 분포를 내놓게 하고, 손실에 그 분포를 $\mathcal{N}(0, I)$ 쪽으로 당기는 KL 항을 더하는 것이다.
