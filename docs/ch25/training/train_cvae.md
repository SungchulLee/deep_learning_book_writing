...
def train_epoch(model, train_loader, optimizer, device, beta=1.0):
    ...
    for data, labels in pbar:
        ...
        # 온전히 이어진 조건부 변분 자기 부호기를 위해 자료를 펼친다
...
??? success "연습문제 5 풀이"
    ...
    자료 부르기에서 표지를 쓰게 되는 점이 실질적인 변화다. 자기 부호기 계열을 쓰다가
...
??? success "연습문제 6 풀이"
    ...
    | 증상 | 무엇을 뜻하는가 |
    |---|---|
    | 부류를 지정해도 아무 숫자나 나온다 | 풀개가 조건을 받지 못한다 |
...
??? success "연습문제 9 풀이"
    ...
    **잣대가 품질의 눈금이 아니다.** 이 장에서 실제로 부딪힌 함정이다. 뽑을 때 $z$에
    ...
    말하려면 [28장](../../ch28/index.md)의 잣대가 필요하고, 그것들도 다양성 문제를
    완전히 풀지는 못한다.
...
??? success "연습문제 10 풀이"
    ...
    **부류별 다시 세우기 오차.** [24장에서 본 대로](../../ch24/ae/reconstruction_analysis.md)
