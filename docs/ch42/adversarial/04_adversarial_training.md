...
62.4 배치: 맞서며 익히기 - 한발 더. 이 배치는 가장 잘 듣는 막이인 맞서며 익히기를 짜 놓았다
...
```python
"""
62.4 배치: 맞서며 익히기 - 한발 더

이 배치는 맞서는 치기를 막는 가장 잘 듣는 길인 맞서며 익히기를 짜 놓았다.
...
class AdversarialTrainer:
    ...
    def _generate_adversarial_examples(
        ...
        # (치는 동안 배치 잣대 잡기와 드롭아웃은 따짐 모드여야 한다)
        self.model.eval()
...
익힘 돌기는 여느 PyTorch 결을 따른다.

고갱이 갈래는 `AdversarialTrainer`, `TRADESTrainer`이며 앞의 연습문제 4개로 스스로 따져 볼 수 있다.
