...
62.2 배치: 되비춘 기울기 내림(PGD) 치기 - 가운데 걸음. 이 배치는 더 센 치기인 되비춘 기울기 내림(PGD)을 짜 놓았다
...
```python
"""
62.2 배치: 되비춘 기울기 내림(PGD) 치기 - 가운데 걸음

이 배치는 FGSM의 더 센 되돌이 갈래인 되비춘 기울기 내림(PGD) 치기를
