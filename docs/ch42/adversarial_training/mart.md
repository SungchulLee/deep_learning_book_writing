...
**MART**(잘못 가름을 아는 맞섬 든든 익히기. 왕 등, 2020)은 옳게 가르기가 얼마나 어려운지에 따라 익힘 보기마다 다른 짐을 주어 맞서며 익히기를 낫게 한다. 고갱이 깨침은 보기가 든든함에 이바지하는 몫이 저마다 다르다는 것이다. 본디 가르기 어려운 보기가 든든하게 익히는 동안 더 어텐션을 받아야 한다.
...
짐 $(1 - p_y(\mathbf{x}))$은 어텐션을 주는 얼개 노릇을 한다.
