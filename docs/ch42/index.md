...
- [맞서는 헝겊](physical/patches.md) -- 참 세상에서 분류기를 속이는, 그 자리에 몰린 찍어 낼 수 있는 흔듦
...
- [아무렇게나 매끄럽게 하기](certified/randomized_smoothing.md) -- 가우스 잡음을 고르게 하여 어떤 분류기든 밝혀 낸 든든함을 지니게 하기
...
- 맞섬에 든든하기 두루 보기 -- 치기, 막이, 따지는 재주를 아우른 배치 두루 보기
...
이 마당은 밑바탕, 흰 상자 치기, 검은 상자 치기, 참 세상 치기를 차례로 짚었다.
