...
이 스크립트는 완전한 MNIST 숫자 분류기를 만드는 실전 예제를 보여준다. 이 개념들을 이해하는 것은 효과적인 PyTorch 프로그래밍과 딥러닝 모델 개발에 필수적이다.
...
**다룬 것** — 실전 예제 - 완전한 MNIST 숫자 분류기

학습 루프는 표준적인 PyTorch 패턴을 따른다.

핵심 클래스는 `SyntheticMNIST`, `ConvNet`이며 앞의 연습문제 3개로 직접 확인할 수 있다.
