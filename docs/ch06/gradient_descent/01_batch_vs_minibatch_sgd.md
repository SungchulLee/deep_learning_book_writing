...
• 기억 자리가 넉넉하고 속도가 필요하면 배치 크기를 키워라
• 지나치게 맞춰지거나 일반화를 높이려면 배치 크기를 줄여라
...
**다룬 것** — 배치, 미니배치, 확률적 경사 하강법

학습 루프는 표준적인 PyTorch 패턴을 따른다.

핵심 클래스는 `SimpleLinearModel`이며 앞의 연습문제 3개로 직접 확인할 수 있다.
