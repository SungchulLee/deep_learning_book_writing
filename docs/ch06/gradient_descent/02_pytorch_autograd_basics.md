...
이 스크립트는 PyTorch autograd의 기초를 보여준다. 이 개념들을 이해하는 것은 효과적인 PyTorch 프로그래밍과 딥러닝 모델 개발에 필수적이다.
...
================================================================================
PART 1: TENSORS WITH GRADIENT TRACKING
================================================================================

Regular tensor: tensor([1., 2., 3.])
requires_grad: False

Tensor with gradient tracking: tensor([1., 2., 3.], requires_grad=True)
requires_grad: True

→ When requires_grad=True, PyTorch tracks all operations on this tensor!

================================================================================
PART 2: SIMPLE GRADIENT COMPUTATION
================================================================================
...
x = 2.0
y = 17.0
Computed gradient dy/dx = 14.0
Expected gradient = 14
✓ Match!

================================================================================
PART 3: COMPUTATIONAL GRAPH
