...
Practical Example: Bias Detection and Mitigation Demonstrates bias detection and mitigation on a synthetic loan approval dataset.
...
**Exercise 4.**
Write a comprehensive test function that validates the Practical Example implementation. Test edge cases including empty inputs, single-element inputs, very large inputs, and inputs with extreme values (zeros, very large numbers).
