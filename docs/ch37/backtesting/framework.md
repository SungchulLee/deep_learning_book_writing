...
고른 몫: 돌아옴=52.31%, 고른 갈아치움=0.0125
사서 지니기: 돌아옴=53.31%, 고른 갈아치움=0.0020
밀림: 돌아옴=27.26%, 고른 갈아치움=0.2947

밀림 꾀의 온 거래 비용: $223,067
```
...
이 틀의 고갱이인 되짚어 시험하기 엔진은 지난 값 자료를 차례대로 다루며, 자리와 몫과 쌓인 돌아옴을 적는 밑천 꾸러미 좇개를 지닌다.

고갱이 갈래는 `BacktestConfig`, `PortfolioTracker`, `BacktestEngine`, `DrawdownAwareEngine`이며 앞의 연습문제 3개로 스스로 따져 볼 수 있다.
