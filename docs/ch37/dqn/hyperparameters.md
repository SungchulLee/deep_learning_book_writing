...
배움 빠르기는 배치 크기, 과녁 고침 잦음, 그물 크기와 세게 얽힌다. 배치가 크면 배움 빠르기를 높여도 견딜 수 있고, 과녁을 자주 고치면 안정을 지키려 배움 빠르기를 낮춰야 한다.
...
1. **배움 빠르기 × 배치 크기**: 배치가 크면 기울기의 흩어짐이 작아지므로 배움 빠르기를 비례해 키울 수 있다(선형 잣수 규칙)
