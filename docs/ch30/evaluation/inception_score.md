# 퍼짐 모형을 위한 인셉션 점수(IS)
인셉션 점수는 미리 익힌 Inception-v3 가름개로 만들어 낸 그림의 품질과 다양함을 따진다. 온전한 수학 이끌어 냄, 짜기, 한계 살핌은 [27.4절의 인셉션 점수](../../ch29/gan_evaluation/inception_score.md)를 보라. 이 쪽은 퍼짐 모형에 남다른 쓰임을 다룬다.
