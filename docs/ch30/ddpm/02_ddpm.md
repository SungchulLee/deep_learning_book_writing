...
이 짜기는 ddpm에 대해 자리 잡은 가장 좋은 방식을 따른다.

고갱이 갈래는 `Config`, `SinusoidalPosEmb`, `ResidualBlock`, `SelfAttention2d`이며 앞의 연습문제 3개로 스스로 따져 볼 수 있다.
