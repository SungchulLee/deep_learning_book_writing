...
??? success "연습문제 5 풀이"
    ...
    보는 손실이다([27장](../../ch26/architecture/encoder.md)).
    ...
    ([27장](../../ch26/architecture/beta_vae.md)).
...
??? success "연습문제 7 풀이"
    ...
    **더하기와 평균.** [27장의 관례](../../ch26/theory/kl_term.md)대로 화소는 더하고
...
변분 오토인코더와 확산 모델은 가능도로 견줄 수 있는가?
