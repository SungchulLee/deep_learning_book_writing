...
제안의 크기를 알맞게 잡고 $d \to \infty$의 끝을 보면 MH 사슬은 확산 과정으로 모인다. 이 확산의 효율(빠르기 상수로 잰다)은 다음과 같다:
...
이 마당은 근본 문제: 다룰 수 없는 고르게 하기, 비의 재주: Z이 왜 필요 없나, 자세한 균형: MH이 왜 과녁으로 모이나, 비가 왜 근본인가를 차례로 짚었다.
