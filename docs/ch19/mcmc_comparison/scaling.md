...
**대표 배치**: 확률 질량이 봉우리가 아니라 얇은 껍질에 몰린다. $\mathcal{N}(0, I_d)$에서는:
...
| 현상 | MCMC에 주는 영향 |
|------------|---------------|
| 부피 몰림 | 무작위 제안이 대표 배치에 좀처럼 맞지 않는다 |
| 대표 배치의 기하 | 봉우리를 찾는 게 아니라 얇은 껍질을 헤쳐 가야 한다 |
...
- 꼬리가 무겁다(기울기가 대표 배치 쪽을 가리키지 않는다)
- 매끄럽지 않은 과녁
...
**어림 규칙**: $L\epsilon$은 대표 배치의 "반지름"의 $\pi/2$배쯤이다.
