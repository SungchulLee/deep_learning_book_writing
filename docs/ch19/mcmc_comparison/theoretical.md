...
**핵심 통찰**: HMC는 조건수에 덜 기대므로 조건이 나쁜 문제에 더 튼튼하다.
...
가장 좋은 질량 행렬을 쓴 HMC가 ($d$에 기대는 인자를 빼면) 이에 이른다.
...
이 마당은 모임 이론의 얼개, 방법마다의 스펙트럼 분석, 가장 좋은 눈금 잡기 이론, 모임 속도 견주기를 차례로 짚었다.
