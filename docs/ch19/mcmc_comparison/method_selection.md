...
**다음이면 무작위 걸음 MH에서 MALA/HMC로 바꿔라**:

- ESS/되풀이 < 0.01
- 섞임 시간 > 되풀이 10,000회
- 자취 그림이 강한 자기상관을 보인다

**다음이면 MALA에서 HMC로 바꿔라**:
...
2. **방법 견주기.** 베이즈 선형 회귀에 무작위 걸음 MH, 깁스, MALA, HMC를 구현하여라. $d \in \{10, 50, 100\}$에서 초당 ESS을 견주어라.
