...
확산 모형은 이어진 잡음 일정을 쓴 여러 눈금 점수 맞추기이다.
...
확산 모형의 "잡음 예측 망" $\epsilon_\theta(x_t, t)$은 점수와 이어져 있다:
...
- **잡음 없애기 점수 맞추기** = 확산 모형의 가르치기 목적 함수
- **담금질한 랑주뱅** = 뒤 확산 과정
- **온도/잡음** = 두 얼개에서 같은 개념
