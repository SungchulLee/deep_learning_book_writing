...
이런 한계 때문에 이 장의 나머지에서 다루는 더 정교한 방법이 나온다. 곧 **물리치기 표집**(16.2절), **중요도 표집**(16.2절), **MCMC**(16.3절)이며, 이들은 곧바른 표집 없이도 복잡한 과녁 분포에서 표본을 만든다.
...
| 중요도 표집 | 한계 없이 줄일 수도 있다 | 좋은 제안 분포 | 16.2절을 보아라 |
