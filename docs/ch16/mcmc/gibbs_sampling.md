...
**핵심 통찰**: 온전한 조건부에서 표집할 수 있으면 MH의 짐 없이 MCMC를 **공짜로** 얻는다!
...
이 마당은 놀라운 결과、판 벌이기: 다변량 과녁、깁스 표집 알고리즘、메트로폴리스-헤이스팅스로 본 깁스을 차례로 짚었다.
