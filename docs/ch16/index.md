...
This chapter covers **MST and Union-Find**.
...
- [Overview](variational_inference/variational_inference_approximating_posterior_overview.md) -- Comprehensive introduction to variational inference and approximate posterior methods
- [Theoretical Background](variational_inference/readme_01_intro.md) -- Bayesian intractability, KL divergence, and the formulation of VI as optimization
- [ELBO and KL Derivation](variational_inference/readme_02_elbo.md) -- Detailed derivation of the evidence lower bound and its relationship to KL divergence
- [ELBO plus KL Identity](variational_inference/readme_03_elbo_plus_kl.md) -- Step-by-step proof of the decomposition of log-evidence into ELBO and KL divergence
- [Approximating the Posterior](variational_inference/readme_01_variational_inference_approximating_posterior.md) -- Using parametric models to approximate the posterior distribution in deep VI settings
...
- [BNNs vs Deep Ensembles](bnn/bnn_vs_ensembles.md) -- Comparing Bayesian and ensemble approaches to uncertainty quantification in theory and practice
...
- [Scalability Challenges](bnn/scalability.md) -- Computational bottlenecks, approximate inference complexity, and hybrid approaches for large-scale BNNs
>>>>>>> 96f31bd (...)
