...
!!! note "여기서 끝, 그다음은 6장"
    ...
    같은 예제를 코드로 시늉해 보는 것과, 최대가능도 추정 자체를 정규분포·회귀·로지스틱 회귀 등 여러 모형에서 일반적으로 다루는 것은 [5.1 최대가능도 추정](../../ch06/mle/mle.md)에 있다. 표지-재포획을 시늉과 함께 더 파헤친 쪽은 [표지-재포획 MLE](../../ch06/mle/capture_recapture_mle.md)다.
