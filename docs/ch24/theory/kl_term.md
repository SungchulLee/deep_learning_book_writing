...
??? success "연습문제 2 풀이"
    ...
    결정적 함수로 되돌아가고, 그러면 [자기 부호기](../../ch23/index.md)와 같아진다.
...
??? success "연습문제 5 풀이"
    ...
    [자기 부호기](../../ch23/index.md)다.

    그리고 자기 부호기가 못 하는 일을 똑같이 못 하게 된다.
    [23.5절](../../ch23/limits/latent_sampling.md)에서 잰 대로 $\mathcal{N}(0,I)$에서
...
??? success "연습문제 6 풀이"
    ...
    이 관점에서 보면 [23장의 여러 벌점](../../ch23/ae/loss_functions.md)과 한 줄에
