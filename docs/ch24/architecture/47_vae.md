...
??? success "연습문제 4 풀이"
    ...
    ([23.5절](../../ch23/limits/latent_sampling.md)).
...
??? success "연습문제 6 풀이"
    **$p(x)$를 정의하기 때문이다.**
    ...
    ([23.5절 연습문제 9](../../ch23/limits/latent_sampling.md)).
...
??? success "연습문제 7 풀이"
    ...
    **음의 로그 가능도**다. 손실의 모양이 곧 $p(x \mid z)$에 대한 가정이다.
    ...
    잘 듣는다([23장 손실 함수](../../ch23/ae/loss_functions.md)에서 BCE가 MSE보다
    나았다).
    ...
    **화소마다 독립**이라는 가정이 훨씬 심각한 문제다. 실제 그림에서 이웃 화소는 강하게
    ...
    모형하고, [퍼짐 모델](../../ch28/index.md)은 아예 다른 길로 간다.
...
??? success "연습문제 10 풀이"
    ...
    ([23장 모듈](../../ch23/architecture/autoencoder.md)).
