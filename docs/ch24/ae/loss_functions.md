...
??? success "연습문제 2 풀이"
    ...
    비가 곧 $\beta$ 노릇을 하기 때문이다([25장](../../ch25/index.md)).
...
??? success "연습문제 3 풀이"
    ...
    [맞겨루기 만들개](../../ch28/index.md)가 손실 자체를 버리고 판별기로 바꾼 까닭
    가운데 하나다.
...
성김 벌점에 쓰는 KL은 [25장](../../ch25/index.md)의 KL 항과 같은 것인가?
...
??? success "연습문제 10 풀이"
    ...
    [변분 자기 부호기](../../ch25/index.md)의 KL 항도 이 목록에 들어간다. 그것은
