...
여기서 배우는 것은 **압축**이지 만들어 내기가 아니다. 숨은 공간에서 코드를 지어내 새 자료를 뽑는 일은 자기 부호기가 약속하지 않으며, 왜 그런지는 [23.5 숨은 공간에서 뽑을 수 있는가](../limits/latent_sampling.md)에서 재어 본다. 그 물음에 답하는 것이 [25장 변분 자기 부호기](../../ch25/index.md)다.
