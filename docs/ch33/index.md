...
- [그래프 트랜스포머](advanced/graph_transformers.md) -- 온 자리 앎을 주고받으려 트랜스포머의 스스로 어텐션을 그래프에 쓰기(Graphormer, GPS)
...
- [그래프 모으기](graph_tasks/pooling.md) -- 마디 박아 넣기를 그래프 나타냄으로 누르는 납작한 모으기 방법(합, 평균, 최대, 어텐션 무게)
