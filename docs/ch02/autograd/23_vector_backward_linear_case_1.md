...
x: tensor([ 1.0000, -2.0000,  0.5000], requires_grad=True)
y = A @ x: tensor([ 1.5000, -5.0000], grad_fn=<MvBackward0>)
v: tensor([ 3., -1.])
x.grad (autograd): tensor([ 5.5000, -3.0000, -4.0000])
A^T v (expected):   tensor([ 5.5000, -3.0000, -4.0000])
```
