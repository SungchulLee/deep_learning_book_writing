...
```
=== Aggregate Analysis ===
n=100: total flips=197, ratio=1.9700, bound=2.0
n=1000: total flips=1994, ratio=1.9940, bound=2.0
n=10000: total flips=19995, ratio=1.9995, bound=2.0

Bit flip frequencies for n=64 increments:
 Bit   Actual    n/2^j
----------------------
   0       64       64
   1       32       32
...
=== Step-by-Step (first 16 increments) ===
 Step     Binary  Flips  Total  Ones  Amortized
----------------------------------------------
    1   00000001      1      1     1       1.00
    2   00000010      2      3     1       1.50
    3   00000011      1      4     2       1.33
    4   00000100      3      7     1       1.75
    5   00000101      1      8     2       1.60
    6   00000110      2     10     2       1.67
    7   00000111      1     11     3       1.57
    8   00001000      4     15     1       1.88
    9   00001001      1     16     2       1.78
   10   00001010      2     18     2       1.80
   11   00001011      1     19     3       1.73
   12   00001100      3     22     2       1.83
   13   00001101      1     23     3       1.77
   14   00001110      2     25     3       1.79
   15   00001111      1     26     4       1.73
   16   00010000      5     31     1       1.94
```
