...
곧 **벌주기는 곧 베이즈이다.** 다만 대칭이 깨진 뒤확률에서는 최빈값과 평균이 갈리고(정리 5), 어느 쪽을 고르든 점 어림값은 불확실성을 버린다. 뒤확률 전체가 필요한 자리에서는 「[믿음 구간](credible_intervals.md)」과 「[깁스 표집](../../ch19/mcmc/gibbs_sampling.md)」으로 넘어가야 한다.
