...
여기서 얻은 뒤확률을 점 하나로 줄이려면 「[최대 뒤확률 어림](map_estimation.md)」을, 구간으로 알리려면 「[믿음 구간](credible_intervals.md)」을, 켤레가 아니어서 손으로 풀 수 없으면 「[깁스 표집](../../ch19/mcmc/gibbs_sampling.md)」을 보라.
