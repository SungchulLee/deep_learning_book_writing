...
| 주제 | 장 | 이음 |
|-------|---------|------------|
| 베이즈 인자 | 17장: 베이즈 인자 | BIC가 로그 베이즈 인자를 어림한다 |
| 모형 증거 | 17장: 모형 증거 | 정보 기준은 온전한 적분을 피한다 |
| 앞확률 고르기 | 17장: 바탕 | BIC는 단위 정보 앞확률을 놓는다 |
| 뒤확률 추론 | 17장: 분포 | DIC과 WAIC은 뒤확률 표본을 쓴다 |
| BNN 견줌 | 17장: BNN | 구조 고르기 |
