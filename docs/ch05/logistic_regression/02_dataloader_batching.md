...
print("="*80)
print("""
1. 쉬움: batch_size=1으로 해 보아라. 작은 배치과 견주면 어떠한가?
...
3. 보통: 배치을 불러오는 동안 데이터 불리기를 더하여라
...
================================================================================
NEXT: 03_model_checkpointing.py - Save and resume training
================================================================================
```
...
**다룬 것** — DataLoader로 배치 처리하기

`LogisticRegression` 클래스는 PyTorch의 `nn.Module` 인터페이스를 사용하여 모델 구조를 감싼다.

핵심 클래스는 `LogisticRegression`, `CustomDataset`이며 앞의 연습문제 4개로 직접 확인할 수 있다.
