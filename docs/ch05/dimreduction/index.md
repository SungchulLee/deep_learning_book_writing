...
규약도 그대로다. Adam $10^{-3}$, 배치 100, 씨앗 42이며, 인코더는 100 에포크를 돈다([4.5절](../../ch04/05_dimensionality_reduction.md)에서 20 에포크로는 모자랐던 것을 보았다).
...
**첫째, 2걸음이 아무것도 벌지 못한다.** [분류 사다리](../../ch04/01_two_ladders.md)에서는 같은 수법이 9.46%포인트를 벌었는데 여기서는 −0.01%포인트, 곧 오히려 아주 조금 잃는다. 까닭은 [AE_Linear](02_ae_linear.md)가 다룬다.
