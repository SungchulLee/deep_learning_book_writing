...
```
======================================================================
LINEAR REGRESSION WITH PYTORCH TENSORS (MANUAL GRADIENTS)
======================================================================
...
Data types:
  X: torch.float32, shape: torch.Size([100])
  y: torch.float32, shape: torch.Size([100])

First 5 samples:
X[:5] = tensor([-2.5092,  9.0143,  4.6399,  1.9732, -6.8796])
y[:5] = tensor([ -3.8443,  18.4306,  10.4633,   0.9712, -13.1986])

======================================================================
PART 2: DEFINE THE MODEL
======================================================================
Initialized parameters:
  w: tensor([0.]), shape: torch.Size([1]), dtype: torch.float32
  b: tensor([0.]), shape: torch.Size([1]), dtype: torch.float32

Initial predictions:
  y_pred[:5]: tensor([0., 0., 0., 0., 0.])
  Initial loss: 137.0771
...
**다룬 것** — PyTorch로 직접 계산하는 선형 회귀

NumPy로 만든 선형 회귀 구현을 PyTorch 텐서로 옮기는 데는 놀랄 만큼 적은 수정만 필요하다.
