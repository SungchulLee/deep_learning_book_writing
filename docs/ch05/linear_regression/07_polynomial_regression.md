...
핵심 통찰: 문제의 복잡도에 맞추어 모델 복잡도를 골라라!
""")
...
2. 모델 복잡도:
   - 차수가 높을수록 너그럽다
   - 너무 단순하면 덜 맞춰진다(편향이 크다)
   - 너무 복잡하면 지나치게 맞춰진다(분산이 크다)
...
======================================================================
Generated 100 samples from cubic function
...
======================================================================
PART 3: TRAIN MODELS WITH DIFFERENT DEGREES
======================================================================
...
다항 특징 확장은 선택한 차수 $d$에 대해 입력 $x$를 벡터 $[1, x, x^2, \ldots, x^d]$로 바꾼다.

핵심 클래스는 `PolynomialRegression`이며 앞의 연습문제 3개로 직접 확인할 수 있다.
