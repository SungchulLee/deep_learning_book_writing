...
GRAN의 덩이 단위 만들기는 금융 낱것 무리가 한꺼번에 시장에 들어오는 상황을 자연스럽게 나타낸다. 보기로 배치 상장, 새 시장 참여자를 낳는 규제 판의 바뀜, 파생 계약의 한꺼번에 맺음이 그렇다. 베르누이 섞음은 금융 이음의 봉우리가 여럿인 성질을 담는다. 거래 상대 관계가 업종, 지역, 규제 관할로 뭉칠 수 있다.
...
이 마당은 덩이 단위 만들기, 구조, 익히기 목표, GraphRNN과 견주기를 차례로 짚었다.
