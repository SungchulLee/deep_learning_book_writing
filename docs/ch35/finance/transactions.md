...
**GAN 바탕 거래 만들기**: 생성기가 거래 차례를 내고 분류기가 참 거래 지난 일과 지어낸 것을 가려내는 GAN을 익힌다. 핵심 어려움은 그럴듯한 때 무늬를 지키면서 관계 얼개(거래가 특정 낱것을 잇는다)를 지키는 것이다.
...
이 마당은 거래 그래프의 얼개, 지어낸 거래 만들기의 길, 사생활을 지키는 지어낸 자료, 자금 세탁 유형 넣기를 차례로 짚었다.
